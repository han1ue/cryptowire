...
const siteData = deserializeFunctions(JSON.parse('{"lang":"en-US","dir":"ltr","title":"CryptoWire Docs","description":"Documentation for the CryptoWire API and monorepo setup.","base":"/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"Guide","link":"/getting-started"},{"text":"API","link":"/api"},{"text":"Deploy","link":"/deployment"}],"sidebar":[{"text":"Start","items":[{"text":"Introduction","link":"/"},{"text":"Getting Started","link":"/getting-started"}]},{"text":"Reference","items":[{"text":"API Endpoints","link":"/api"},{"text":"Deployment","link":"/deployment"}]}],"search":{"provider":"local"}},"locales":{},"scrollOffset":134,"cleanUrls":true}'));
...
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => import("./VPLocalSearchBox.CItoZuY9.js"));
